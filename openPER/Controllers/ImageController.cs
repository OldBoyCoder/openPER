...
namespace openPER.Controllers
{
    public class ImageController : Controller
    {
        ...
        public ActionResult Thumbnail(int releaseCode, decimal clichePartNumber, int clichePartDrawingNumber)
        {
            var imageName =
        ...
        public ActionResult Drawing(int releaseCode, decimal clichePartNumber, int clichePartDrawingNumber)
        {
            var imageName =
                _repository.GetImageNameForClicheDrawing(releaseCode, clichePartNumber, clichePartDrawingNumber);
