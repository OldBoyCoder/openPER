...
namespace openPERRepositories.Repositories
{
    public class VersionedImageRepository : IVersionedImageRepository
    {
        ...
        public byte[] GetThumbnailForCliche(int releaseCode, decimal clichePartNumber, int clichePartDrawingNumber, string imageName)
        {
            return releaseCode switch
            {
        ...
        public byte[] GetImageForCliche(int releaseCode, decimal clichePartNumber, int clichePartDrawingNumber, string imageName)
        {
            return releaseCode switch
            {
                18 => _repository18.GetImageForCliche(clichePartNumber, clichePartDrawingNumber, imageName),
                84 => _repository84.GetImageForCliche(clichePartNumber, clichePartDrawingNumber, imageName),
                _ => null
            };
        }
    }
